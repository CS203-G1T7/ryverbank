...
//         requestParams.put("quantity", buyQuantity);
...
//                 .statusCode(200)
//                 .contentType("application/json")
//                 .body("balance", equalTo(TestConstants.account_balance_1 - avg_price*buyQuantity));
...
//         buyQuantity = buyQuantity + filled_quantity;
...
//                 .statusCode(200)
//                 .contentType("application/json")
//                 .body("balance", equalTo(TestConstants.account_balance_1 - avg_price*volume));
...
//         assertEquals(buyQuantity, quantities.get(0));
//     }
