...
class UserIntegrationTest {
	...
	public void addUser_Success() {
		User user = new User("mtan123", encoder.encode("12345password"), "ROLE_MANAGER", "mtan", "S0476984H", "91251234", "27 Jalan Alamak S680234", true);
		ResponseEntity<String> responseEntity = this.restTemplate.postForEntity("http://localhost:" + port + "/users", user, String.class);
