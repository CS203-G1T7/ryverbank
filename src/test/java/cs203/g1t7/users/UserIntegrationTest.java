...
import cs203.g1t7.security.SecurityConfig;
...
class UserIntegrationTest {
	...
	// 	User user = new User("mtan123", encoder.encode("12345password"), "ROLE_USER", "mtan", "S0476984H", "91251234", "27 Jalan Alamak S680234", true);
		
	// 	User manager = new User("admin", encoder.encode("goodpassword"), "ROLE_MANAGER", "jimtan", "S9794462H", "81235768", "Jalan Cilandak 78 Mandala", true);
	// 	users.save(manager);
